    ...
    <div className="w-full">
      ...
      <div className="hidden md:flex items-center justify-center gap-4">
        <div className="relative">
          <button
            onClick={toggleDropdown}
            className="flex items-center gap-1 px-3 py-2 rounded bg-transparent text-important border border-important hover:bg-important hover:text-[#e0f2f1]"
          >
            <span>{selectedFilter || "Filter"}</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <input
          ...
          onChange={handleSearchInput}
          onKeyDown={handleKeyDown}
          className="w-[500px] bg-transparent placeholder:text-important text-important font-semibold border border-important rounded-md px-4 py-2"
          placeholder="Search venues..."
        />

        <button
          onClick={handleSearch}
          className="flex items-center gap-1 px-4 py-2 text-important border border-important hover:bg-important hover:text-[#e0f2f1] rounded"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
